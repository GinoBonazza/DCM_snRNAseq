...
Clinical_data <- read_excel(here::here("data", "DCM_Clinical_data.xlsx"))
...
```{r QC_pre_VlnPlots, fig.height=6, fig.width=12}
...
```{r QC_pre_VlnPlots_zoom, fig.height=10, fig.width=12}
...
```{r QC_pre_Doublets, fig.height=3, fig.width=12}
...
rm(DCM_RV, DCM_RV_preQC_no_doublets)
```
...
DCM_RV_integrated <- subset(DCM_RV_integrated, subset = SCT_snn_res.0.2 != "8")
```
