---
title: "Cardiomyocytes subclustering including HC"
...
current_file <- "Cardiomyocytes_subclustering_26"
...
DCM_RV_integrated <- readRDS(here::here("output", "QC_integration_annotation_26", "DCM_RV_integrated_RNA.rds"))
...
VlnPlot(CM, features = c("LINC02388", "LDB3", "ARHGAP24", "NRAP"), ncol = 4)
```

```{r FeatPlot_markers_CM, fig.width=12, fig.height=3}
FeaturePlot(CM, features = c("LINC02388", "LDB3", "ARHGAP24", "NRAP"), ncol = 4)
```
...
```{r Barplot_CM_Group, fig.height=6, fig.width=6, message=FALSE}
color_palette_all <- c("#F8766D", "#00C1AB", "#24B700", "#E18A00", "#00ACFC", "#D575FE", "#BE9C00", "#00BE70", 
                   "#8CAB00", "#00BBDA", "#FF65AC", "#8B93FF", "#EA8331")
color_palette <- c("#F8766D", "#24B700", "#E18A00", "#00ACFC", "#D575FE")
...
barplot(props$Proportions, legend = FALSE, ylab = "Proportions", col = color_palette, 
        cex.names = 2, las = 2, font.lab = 2, font.axis = 2, cex.axis = 1.2, cex.lab = 2)
legend("topright", inset = c(-0.45, 0.15), legend = rownames(props$Proportions), fill = color_palette, bty = "n", cex = 2)
```
