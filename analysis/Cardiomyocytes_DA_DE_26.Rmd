...
write.csv(differential_abundance_HC, file = here::here(output_dir_data, "CM_Differential_Abundance_HC.csv"), quote=F, row.names = F)
...
write.csv(percent_stats, file = here::here(output_dir_data, "CM_percent_stats.csv"), quote=F, row.names = F)
```
...
```{r UpSet_plot_DE, fig.height=5, fig.width=9}
gene_sets <- list()
...
counts_tibble <- counts_matrix %>%
  ...
  dplyr::mutate(Condition = dplyr::case_when(
    ...
    sample %in% c("PK439", "PK375", "PK229", "P5", "P8", "PK153") ~ "DCM - mPAP 19-27 mmHg",
    sample %in% c("PK385", "PK437", "PK323", "PK403", "PK213", "PK461") ~ "DCM - mPAP 28-35 mmHg",
    sample %in% c("PK369", "PK357", "PK337", "PK345", "PK401", "PK463") ~ "DCM - mPAP 36-48 mmHg"
  ))
...
```{r Clustering_DEGs, fig.height=3.5, fig.width=9}
...
mean_tibble_cluster$Condition <- factor(mean_tibble_cluster$Condition, levels = c("HC", "DCM - mPAP 19-27 mmHg", "DCM - mPAP 28-35 mmHg", "DCM - mPAP 36-48 mmHg"))
...
reactable(top_DEGs_mPAP_cluster1, 
          filterable = TRUE,
          searchable = TRUE,
          showPageSizeOptions = TRUE)
```
...
reactable(top_DEGs_mPAP_cluster2, 
          filterable = TRUE,
          searchable = TRUE,
          showPageSizeOptions = TRUE)
```
...
reactable(top_DEGs_mPAP_cluster3, 
          filterable = TRUE,
          searchable = TRUE,
          showPageSizeOptions = TRUE)
```
...
reactable(top_DEGs_mPAP_cluster4, 
          filterable = TRUE,
          searchable = TRUE,
          showPageSizeOptions = TRUE)
```
...
CM@meta.data[CM@meta.data$Sample %in% c("PK439", "PK375", "PK229", "P5", "P8", "PK153"), "Condition"] = "DCM - mPAP 19-27 mmHg"
CM@meta.data[CM@meta.data$Sample %in% c("PK385", "PK437", "PK323", "PK403", "PK213", "PK461"), "Condition"] = "DCM - mPAP 28-35 mmHg"
CM@meta.data[CM@meta.data$Sample %in% c("PK369", "PK357", "PK337", "PK345", "PK401", "PK463"), "Condition"] = "DCM - mPAP 36-48 mmHg"
CM@meta.data[CM@meta.data$Sample %in% c("P3", "PK415", "PK441"), "Condition"] = "DCM - no mPAP data"

CM$Condition <- factor(CM$Condition, levels = c("HC", "DCM - mPAP 19-27 mmHg", "DCM - mPAP 28-35 mmHg", "DCM - mPAP 36-48 mmHg", "DCM - no mPAP data"))
```
