...
VlnPlot_scCustom(CM, features = c("LINC02388", "MIR646HG", "NRAP", "ARHGAP24", "DAPK2"), num_columns = 5, colors_use = cell_type_cols, pt.size = 0)
```
...
```{r Speckle_LVEDD_mm, fig.height=8, fig.width=12}
...
```{r Speckle_LVEF_percent, fig.height=8, fig.width=12}
...
```{r Speckle_mPAP_mmHg, fig.height=8, fig.width=12}
...
```{r h5ad, eval = FALSE}
SaveH5Seurat(CM, here::here(output_dir_data, "CM.h5Seurat"), overwrite = TRUE)
